...
namespace Lunchly.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {   
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.KichenUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.KichenUser));
                    }
                    ...
                    if(role == SD.KichenUser)
                        await _userManager.AddToRoleAsync(user, SD.KichenUser);
                    else
                    {
